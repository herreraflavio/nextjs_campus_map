...
// working version bellow 11/15/2025 2:05 am
// "use client";
...
//           // Popup might be nullable in types, so guard once
//           const popup = view.popup;
//           if (popup) {
//             popup.dockEnabled = false;
//             popup.dockOptions = {
...
//     // tiny poller so we *always* wait for ArcGIS AMD loader,
//     // even when the script is a bit late
//     if ((window as any).require) {
//       startArcGIS();
//     } else {
//       let tries = 0;
...
//   //   const amd = (window as any).require;
//   //   if (!amd) {
//   //     console.error("ArcGIS AMD loader not available");
//   //     return;
//   //   }
...
//           (editingLayer as any).z = 40;
//           (eventsLayer as any).z = 45;
//           (labelsLayer as any).z = 70; // keep above routes (z=60)
...
//           // Auto-resort on collection changes
//           (map.layers as any).on("change", () => resortByZ(map));
...
// /* ─────────────────────────────────────────
//  * Z-order helper (global for the map)
//  * ───────────────────────────────────── */
...
//           // Canonical z values (bottom -> top)
//           (mediaLayer as any).z = 10;
//           (campusTiles as any).z = 15;
//           (finalizedLayer as any).z = 30;
//           (editingLayer as any).z = 40;
//           (eventsLayer as any).z = 45;
//           (labelsLayer as any).z = 70; // always above routes (z=60)
...
//                   popupTemplate: config.popupTemplate || undefined,
//                 });
//                 // Use provided "index" as our z, or 0
//                 (fl as any).z = fl.index ?? 0;
//                 fl.id = `feature:${index}`;
//                 layers.push(fl);
//               } catch (e) {
...
//           // Add and immediately enforce z ordering
//           map.addMany(allLayers);
//           resortByZ(map);

//           /* Auto-resort whenever layers are added/removed/moved dynamically */
//           map.layers.on("change", () => resortByZ(map));
